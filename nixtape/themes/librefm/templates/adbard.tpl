	    <div id="adbard" style="height: 248px; width: 182px; position: relative;">

	    <!--Ad Bard advertisement snippet, begin -->

	    <div style="background-color: yellow; position: absolute; width: 205px; height: 140px;"><script type='text/javascript'>
