...
<div id='user-edit'>
	...
	<dl>
		...
		<dd>{t escape=no}An RSS feed which will be used to populate your journal on Libre.fm. Defaults to your StatusNet RSS feed if you provide your StatusNet micro-blog address.{/t}</dd>
