...
<div id="nowtracks">
		<?php
                        if(empty($req_user)) {
                               ...
                               $res = $mdb2->query("SELECT username, artist, track, client from Now_Playing left outer join Scrobble_Sessions on Now_Playing.sessionid=Scrobble_Sessions.sessionid WHERE username = '" . stripslashes($req_user) . "' ORDER BY Now_Playing.expires DESC LIMIT 10");
                        }
